...
class SiT(nn.Module):
    ...
    def forward_with_cfg(self, x, t, y, cfg_scale, guidance_high=1000, guidance_low=0, cond=None):
        """
        Forward pass of SiT, but also batches the unconSiTional forward pass for classifier-free guidance.
        """
        if (t[0] >= guidance_low/1000) and (t[0] <= guidance_high/1000):
            half = x[: len(x) // 2]
            ...
            return self.forward(x, t, y, cond=cond)
